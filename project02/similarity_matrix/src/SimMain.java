...
public class SimMain {
	public static void main(String[] arg){
		...
		System.out.println(); 
		System.out.println("The Jaccard coefficient between 1 and 2 is : " + alg.smc(bina, binb));
		System.out.println("The Jaccard coefficient between 1 and 3 is : " + alg.smc(bina, binc));
	}
